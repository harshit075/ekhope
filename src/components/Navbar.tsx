  ...
  return (
    <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
      <div className="container flex justify-between items-center h-full">
        ...
        {/* Desktop Nav */}
        <div className="nav-links flex gap-4 lg:gap-8 items-center hidden lg:flex">
          ...
          <a href="upi://pay?pa=8305134724@ybl&pn=Ekhope&cu=INR&am=1100" className="btn btn-primary pulse-btn" style={{ padding: '0.6rem 1.75rem', flexShrink: 0 }}>Donate</a>
        </div>

        {/* Mobile Menu Toggle */}
        <button className="mobile-toggle lg:hidden" onClick={() => setMobileMenuOpen(!mobileMenuOpen)} aria-label="Toggle menu">
